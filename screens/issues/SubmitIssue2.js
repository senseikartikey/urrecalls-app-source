...
export default class SignupScreen extends Component {
  ...
  reportIssue = () => {
    ...
    if (Pname === "" || UPC === "" || title === "" || description === "") {
      ...
      xhttp.open(
        "POST",
        "http://ec2-34-227-36-231.compute-1.amazonaws.com/general/InsertDrugIssue",
        true
      );
      ...
      xhttp.send(
        `name=${Pname}&title=${title}&NDC=${UPC}&description=${description}&user_id=${state}`
      );
    }
  };
  render() {
        ...
        >
          ...
          <ScrollView>
            <Text style={styles.text}>
              This is the Drug issue page. Here you can submit personal problems
