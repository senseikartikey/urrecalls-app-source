...
export default class SignupScreen extends Component {
  ...
  reportIssue = () => {
    ...
    if (
      ...
      xhttp.open(
        "POST",
        "http://ec2-34-227-36-231.compute-1.amazonaws.com/general/InsertCarIssue",
        true
      );
      ...
      xhttp.send(
        `make=${make}&model=${model}&year=${year}&title=${title}&description=${description}&user_id=${state}`
      );
    }
  };
  render() {
        ...
        >
          ...
          <ScrollView>
            <Text style={styles.text}>
              This is the Vehicle issue page. Here you can submit personal
              problems you had with a product. Enter the values below as well as
              anything else you would like to share about your experience with
              the product.{"\n"}
            </Text>
